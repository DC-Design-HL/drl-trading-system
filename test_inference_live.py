import pandas as pd
import logging
from src.features.confidence_engine import ConfidenceEngine
from live_trading_multi import MultiAssetTradingBot

logging.basicConfig(level=logging.INFO)

def test_inference():
    print("Initializing Bot for SOLUSDT...")
    bot = MultiAssetTradingBot("SOLUSDT", dry_run=True, initial_balance=10000)
    
    print("Fetching data...")
    df = bot.fetch_data(days=7)
